package pers.prover07.guli.serviceenv.tools.impl;
...
public class CustomRedisCacheManager implements IGlobalCache {

    private final RedisTemplate<String, Object> redisTemplate;

    public CustomRedisCacheManager(RedisTemplate<String, Object> redisTemplate) {
